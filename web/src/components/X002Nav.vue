  ...
  <div class="bg-base-300 text-base-content z-40 flex min-h-full w-80 flex-col p-4 shadow">
    ...
    <ul class="menu mt-6 grow p-0 [&_li>*]:rounded-none">
      <li>
        ...
        <ul>
          <li>
            <router-link to="/start" @click="closeDrawer"
      ...
      <li>
        <router-link to="/results" @click="closeDrawer">
    ...
    <div class="flex justify-between px-4">
      <router-link to="/entry" class="btn btn-warning" @click="closeDrawer">
