...
var C1Table = /*#__PURE__*/function (_Component) {
  ...
  _createClass(C1Table, [{
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 14:
              ...
              htmlDoc = parser.parseFromString(_template_hbs__WEBPACK_IMPORTED_MODULE_6___default()(data), 'text/html');
    ...
    value: function _addListeners() {
        ...
        var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(event) {
          ...
          return _regeneratorRuntime().wrap(function _callee2$(_context2) {
            while (1) switch (_context2.prev = _context2.next) {
              ...
              case 2:
                _context2.next = 4;
                return _c3_confirm__WEBPACK_IMPORTED_MODULE_4__["default"].openAndWait('default');
              case 4:
      ...
      if (this._ref('filter')) this._addListener('submit', function (event) {
        event.preventDefault();
        _this2.currentFilter = (0,_libs_form_to_json__WEBPACK_IMPORTED_MODULE_2__.formToJSON)(event.target);
      ...
      for (var i = 0; i < this.keys.length; i++) {
        ...
        switch (type) {
          case 'date-time':
            ...
            break;
          case 'penalty':
            data = item[key] && item[key] != 0 ? "".concat(Math.sign(item[key]) > 0 ? '+' : '-').concat(item[key], " sec") : null;
            break;
          case 'time':
            data = (0,_libs_utils__WEBPACK_IMPORTED_MODULE_3__.dateToTime)(item[key], true);
            break;
          case 'diff':
            data = data ? "<span class=\"underline font-bold\">".concat((0,_libs_utils__WEBPACK_IMPORTED_MODULE_3__.dateToDiffTimeStr)(item[key], true), "</span>") : null;
            break;
          case 'bolder':
    ...
    value: function _generateRows() {
      ...
      if (this.orderBy) {
        finalRows.sort(function (one, two) {
          ...
          if (a[_this3.orderBy] === undefined || a[_this3.orderBy] === null) {
            return 1;
          }
          if (b[_this3.orderBy] === undefined || b[_this3.orderBy] === null) {
            return -1;
          }
          if (a[_this3.orderBy] < b[_this3.orderBy]) {
            return -1;
      ...
      // render rows
      var rowsHtmls = [];
      var _iterator = _createForOfIteratorHelper(finalRows),
        _step;
      try {
    ...
    value: function addRow(row) {
      ...
      var htmlDoc = parser.parseFromString('<table>' + _row_template_hbs__WEBPACK_IMPORTED_MODULE_5___default()(mappedRow) + '</table>', 'text/html');
    ...
    value: function () {
      var _openAndWait = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(name) {
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              dialog = document.querySelector("c3-confirm[name=".concat(name, "]"));
              if (dialog) {
                _context2.next = 3;
                break;
              }
...
var waitForClose = (0,_libs_utils__WEBPACK_IMPORTED_MODULE_2__.buildWaitForEvent)('close');
var C4Penalty = /*#__PURE__*/function (_Component) {
  _inherits(C4Penalty, _Component);
  var _super = _createSuper(C4Penalty);
  function C4Penalty() {
    var _this;
    _classCallCheck(this, C4Penalty);
    _this = _super.call(this);
    _this._init();
    return _this;
  }
  _createClass(C4Penalty, [{
    key: "_init",
    value: function () {
      var _init2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        var _this2 = this;
          ...
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              this._addListener('submit', function (event) {
                ...
                _this2.close(parseInt(data.penalty));
              }, this.penaltyForm);
              this._addListener('click', function () {
                _this2.close();
              }, this.noBtn);
    ...
    key: "close",
    value: function close() {
      var penalty = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : -1;
      this.dispatchEvent(new CustomEvent('close', {
        detail: penalty
      }));
      this.root.classList.add('hidden');
    ...
    key: "open",
    value: function open() {
      var _this$penaltyForm, _this$noBtn;
      (_this$penaltyForm = this.penaltyForm) === null || _this$penaltyForm === void 0 ? void 0 : _this$penaltyForm.reset();
      this.root.classList.remove('hidden');
      (_this$noBtn = this.noBtn) === null || _this$noBtn === void 0 ? void 0 : _this$noBtn.focus();
    }
  }], [{
    ...
    value: function () {
      var _openAndWait = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(name) {
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              dialog = document.querySelector("c4-penalty[name=".concat(name, "]"));
              if (dialog) {
                _context2.next = 3;
                break;
              }
            ...
            case 6:
              event = _context2.sent;
              return _context2.abrupt("return", event.detail);
            case 8:
            case "end":
              return _context2.stop();
          }
...
var L2Main = /*#__PURE__*/function (_Component) {
  ...
  function L2Main() {
    ...
    setInterval(function () {
      if (_this.currentTime) _this.currentTime.innerHTML = (0,_libs_utils__WEBPACK_IMPORTED_MODULE_3__.dateToTime)(new Date());
    }, 1000);
    return _this;
  }
  _createClass(L2Main, [{
    ...
    value: function _addStoreListeners() {
      ...
      this._addStoreListener('events', function (path, data) {
        if (data.ok) {
          _this2._ref('okConnect').classList.remove('hidden');
          _this2._ref('notConnect').classList.add('hidden');
        } else {
          _this2._ref('okConnect').classList.add('hidden');
          _this2._ref('notConnect').classList.remove('hidden');
        }
      });
    }
  }, {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              this._addListener('click', function () {
                if (!_this3.drawerMenu.classList.contains('-left-64')) {
                  _this3.drawerMenu.classList.add('-left-64');
                } else {
              ...
              this._addListener('click', function () {
                if (_this3.drawerMenu.classList.contains('-left-64')) {
                  _this3.drawerMenu.classList.remove('-left-64');
                } else {
                  _this3.drawerMenu.classList.add('-left-64');
                }
              }, 'menuBtn');
        ...
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            ...
            case 5:
              ...
              _context4.next = 8;
              return _c4_penalty__WEBPACK_IMPORTED_MODULE_5__["default"].openAndWait('default');
            case 8:
              penalty = _context4.sent;
              if (!(penalty == -1)) {
                _context4.next = 11;
                break;
              }
  ...
  _createClass(M4Score, [{
    ...
    value: function () {
      var _uploadPsScore2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(form) {
        var files, selection, f, arrayBuffer, decoder, csv, results, runners, rows, _iterator, _step, _runners$row$number, row, runner, endDate, time, pen;
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              files = form.querySelector('[type=file]').files;
            ...
            case 3:
              _context3.next = 5;
              return _c3_confirm__WEBPACK_IMPORTED_MODULE_7__["default"].openAndWait('default');
            case 5:
            ...
            case 8:
              _context3.next = 10;
              return this.dbManager.cleanTakeByPs({
                race: this.raceId,
                ps: this.psId
              });
            case 10:
              ...
              f = files[0];
              _context3.next = 13;
              return (0,_libs_utils__WEBPACK_IMPORTED_MODULE_5__.readFileAsync)(f);
            case 13:
              arrayBuffer = _context3.sent;
              decoder = new TextDecoder('utf-8');
              csv = decoder.decode(arrayBuffer); //read csv
              ...
              return this.dbManager.getAllRunner(this.raceId);
            case 19:
              runners = _context3.sent;
              runners = runners.reduce(function (result, item) {
            ...
            case 25:
              ...
              row = _step.value;
              runner = (_runners$row$number = runners[row.number]) === null || _runners$row$number === void 0 ? void 0 : _runners$row$number.id;
              if (runner) {
                _context3.next = 30;
                break;
              }
            ...
            case 35:
              time = _context3.sent;
              pen = row.pen ? parseInt(row.pen) : 0;
              _context3.next = 39;
              return this.dbManager.createTake({
                race: this.raceId,
                ps: this.psId,
    ...
    key: "_print",
    value: function () {
      var _print2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5() {
        var title, subtitle;
        return _regeneratorRuntime().wrap(function _callee5$(_context5) {
          while (1) switch (_context5.prev = _context5.next) {
            case 0:
              title = "<h1 class=\"text-3xl font-bold mb-4 mt-8\">Risultati</h1>";
              subtitle = '';
              if (this.categories.length > 0) {
                subtitle += "<p class=\"mt-2 text-lg mb-4\">Categorie: <b class=\"text-xl\">".concat(this.categories.join(' - '), "</b></p>");
              }
              if (this.teams.length > 0) {
                subtitle += "<p class=\"mt-2 text-lg mb-4\">Team: <b class=\"text-xl\">".concat(this.teams.join(' - '), "</b></p>");
              }
...
var M5Results = /*#__PURE__*/function (_Component) {
  _inherits(M5Results, _Component);
  var _super = _createSuper(M5Results);
  function M5Results() {
    var _this;
    _classCallCheck(this, M5Results);
    _this = _super.call(this);
    _this.dbManager = (0,_libs_db_manager__WEBPACK_IMPORTED_MODULE_2__.getDBManager)();
    _this._init();
    return _this;
  }
  _createClass(M5Results, [{
    key: "_init",
    value: function () {
      var _init2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        var _this2 = this;
        var selectedRace, data, parser, htmlDoc;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              // load raceId
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            ...
            case 2:
              ...
              csv = papaparse__WEBPACK_IMPORTED_MODULE_0___default().unparse(rows);
              csvContent = 'data:text/csv;charset=utf-8,' + csv;
              window.open(encodeURI(csvContent));
            case 8:
            case "end":
    ...
    key: "_print",
    value: function () {
      var _print2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
        var title, subtitle;
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
  ...
  _createClass(DBManager, [{
    ...
    value: function () {
      var _createOrUpdateRunner = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee11(_ref6) {
        var name, number, category, race, team, id, naz, uci, fci, soc;
        return _regeneratorRuntime().wrap(function _callee11$(_context11) {
          while (1) switch (_context11.prev = _context11.next) {
            case 0:
              name = _ref6.name, number = _ref6.number, category = _ref6.category, race = _ref6.race, team = _ref6.team, id = _ref6.id, naz = _ref6.naz, uci = _ref6.uci, fci = _ref6.fci, soc = _ref6.soc;
              if (!id) {
                _context11.next = 7;
                break;
              }
    ...
    key: "getTake",
    value: function () {
      var _getTake = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee18(id) {
        return _regeneratorRuntime().wrap(function _callee18$(_context18) {
          while (1) switch (_context18.prev = _context18.next) {
            case 0:
              _context18.next = 2;
              return this.db.take.get(parseInt(id));
            case 2:
      ...
      function getTake(_x17) {
        return _getTake.apply(this, arguments);
      }
      return getTake;
    }()
  }, {
    key: "getTakeBy",
    value: function () {
      var _getTakeBy = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee19(_ref11) {
        var ps, runner, race;
    ...
    key: "getAllTake",
    value: function () {
      var _getAllTake = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee20(race, ps) {
    ...
    key: "createTake",
    value: function () {
      var _createTake = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee21(_ref12) {
        var time, ps, runner, race, _ref12$pen, pen;
        return _regeneratorRuntime().wrap(function _callee21$(_context21) {
          while (1) switch (_context21.prev = _context21.next) {
            case 0:
              time = _ref12.time, ps = _ref12.ps, runner = _ref12.runner, race = _ref12.race, _ref12$pen = _ref12.pen, pen = _ref12$pen === void 0 ? 0 : _ref12$pen;
              _context21.next = 3;
    ...
    key: "deleteTake",
    value: function () {
      var _deleteTake = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee22(_ref13) {
        var id;
    ...
    key: "cleanTake",
    value: function () {
      var _cleanTake = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee23(_ref14) {
        var race, array, ids;
    ...
    key: "cleanTakeByPs",
    value: function () {
      var _cleanTakeByPs = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee24(_ref15) {
        var race, ps, array, ids;
        return _regeneratorRuntime().wrap(function _callee24$(_context24) {
          while (1) switch (_context24.prev = _context24.next) {
            case 0:
              race = _ref15.race, ps = _ref15.ps;
              _context24.next = 3;
              return this.db.take.where({
                race: parseInt(race),
                ps: parseInt(ps)
      ...
      function cleanTakeByPs(_x24) {
        return _cleanTakeByPs.apply(this, arguments);
      }
      return cleanTakeByPs;
    }()
  }, {
    key: "setPenalty",
    value: function () {
      var _setPenalty = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee25(id, penalty) {
        return _regeneratorRuntime().wrap(function _callee25$(_context25) {
          while (1) switch (_context25.prev = _context25.next) {
            case 0:
              _context25.next = 2;
              return this.db.take.update(parseInt(id), {
      ...
      function setPenalty(_x25, _x26) {
        return _setPenalty.apply(this, arguments);
      }
      return setPenalty;
    }() ////////////////////////////////////////////////////////////////////////////////// special
  }, {
    key: "getTimeJoin",
    value: function () {
      var _getTimeJoin = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee26(id) {
        ...
        return _regeneratorRuntime().wrap(function _callee26$(_context26) {
          while (1) switch (_context26.prev = _context26.next) {
            ...
            case 5:
              ...
              return _context26.abrupt("return", _objectSpread({}, time));
            case 8:
              _context26.next = 10;
            ...
            case 10:
              ...
              return _context26.abrupt("return", _objectSpread({}, time));
            case 13:
              return _context26.abrupt("return", _objectSpread(_objectSpread({}, time), {}, {
    ...
    key: "getAllTimeJoin",
    value: function () {
      var _getAllTimeJoin = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee28(race) {
        var _this = this;
        var onlyNotAssigned,
          times,
          result,
        ...
        return _regeneratorRuntime().wrap(function _callee28$(_context28) {
          while (1) switch (_context28.prev = _context28.next) {
            case 0:
              onlyNotAssigned = _args28.length > 1 && _args28[1] !== undefined ? _args28[1] : false;
              _context28.next = 3;
              return this.getAllTime(race);
            case 3:
              times = _context28.sent;
              _context28.next = 6;
              return Promise.all(times.map( /*#__PURE__*/function () {
                var _ref16 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee27(time) {
                  var found, runner, ps;
                  return _regeneratorRuntime().wrap(function _callee27$(_context27) {
                    while (1) switch (_context27.prev = _context27.next) {
                      ...
                      case 2:
                        found = _context27.sent;
                        if (!(!found || found.length == 0)) {
                          _context27.next = 5;
                          break;
                        }
                        return _context27.abrupt("return", time);
                      case 5:
                        _context27.next = 7;
                        return _this.db.runner.get(found[0].runner);
                      case 7:
                        runner = _context27.sent;
                        _context27.next = 10;
                      ...
                      case 10:
                        ...
                        return _context27.abrupt("return", _objectSpread({}, time));
                      case 13:
                        return _context27.abrupt("return", _objectSpread(_objectSpread({}, time), {}, {
                          assigned: runner.number,
                          assignedName: runner.name,
                          assignedPs: ps.name
                        }));
    ...
    value: function () {
      var _getAllTakeJoinWithoutScore = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee30(race, psId) {
        var _this2 = this;
        var takes, result;
        return _regeneratorRuntime().wrap(function _callee30$(_context30) {
          while (1) switch (_context30.prev = _context30.next) {
            ...
            case 2:
              takes = _context30.sent;
              _context30.next = 5;
              return Promise.all(takes.map( /*#__PURE__*/function () {
                var _ref17 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee29(take) {
                  var time, runner, ps;
                  return _regeneratorRuntime().wrap(function _callee29$(_context29) {
                    while (1) switch (_context29.prev = _context29.next) {
                      ...
                      case 2:
                        time = _context29.sent;
                        _context29.next = 5;
                        return _this2.db.runner.get(take.runner);
                      case 5:
                        runner = _context29.sent;
                        _context29.next = 8;
                      ...
                      case 8:
                        ...
                        return _context29.abrupt("return", _objectSpread({}, take));
                      case 11:
                        return _context29.abrupt("return", _objectSpread(_objectSpread({}, take), {}, {
      ...
      function getAllTakeJoinWithoutScore(_x30, _x31) {
    ...
    value: function () {
      var _getAllTakeJoinWithScore = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee31(race, psId) {
        ...
        return _regeneratorRuntime().wrap(function _callee31$(_context31) {
          while (1) switch (_context31.prev = _context31.next) {
            ...
            case 2:
              ...
              return _context31.abrupt("return", result.slice(Math.max(0, firstTakeIndex - 3)));
            case 8:
            case "end":
      ...
      function getAllTakeJoinWithScore(_x33, _x34) {
    ...
    value: function () {
      var _getAllCategories = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee32(race) {
        ...
        return _regeneratorRuntime().wrap(function _callee32$(_context32) {
          while (1) switch (_context32.prev = _context32.next) {
            ...
            case 2:
              ...
              return _context32.abrupt("return", _toConsumableArray(new Set(categories)));
            case 5:
            case "end":
      ...
      function getAllCategories(_x35) {
    ...
    key: "getAllTeams",
    value: function () {
      var _getAllTeams = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee33(race) {
        var runners, teams;
        return _regeneratorRuntime().wrap(function _callee33$(_context33) {
          while (1) switch (_context33.prev = _context33.next) {
            ...
            case 2:
              ...
              return _context33.abrupt("return", _toConsumableArray(new Set(teams)));
            case 5:
            case "end":
    ...
    key: "getScoreFull",
    value: function () {
      var _getScoreFull = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee34(psId, race) {
        ...
        return _regeneratorRuntime().wrap(function _callee34$(_context34) {
          while (1) switch (_context34.prev = _context34.next) {
            ...
            case 10:
              ...
              return this.getAllTake(race, psId);
            case 12:
              takes = _context34.sent;
              takesObj = {};
              _iterator = _createForOfIteratorHelper(takes);
              try {
                for (_iterator.s(); !(_step = _iterator.n()).done;) {
                  _take = _step.value;
                  takesObj[_take.runner] = _take;
                }
            ...
            case 38:
              ...
              break;
            case 41:
              return _context34.abrupt("return", tmpResult);
            case 42:
            case "end":
      ...
      function getScoreFull(_x37, _x38) {
    ...
    key: "getScore",
    value: function () {
      var _getScore = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee35(psId, race, categories, teams) {
      ...
      function getScore(_x39, _x40, _x41, _x42) {
    ...
    key: "getGlobalScore",
    value: function () {
      var _getGlobalScore = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee36(race, categories, teams) {
        ...
        return _regeneratorRuntime().wrap(function _callee36$(_context36) {
          while (1) switch (_context36.prev = _context36.next) {
            ...
            case 44:
              _context36.prev = 44;
              _context36.t1 = _context36["catch"](12);
              _iterator2.e(_context36.t1);
            case 47:
              _context36.prev = 47;
              _iterator2.f();
            ...
            case 50:
              ...
              return _context36.abrupt("return", results);
            case 57:
            case "end":
              return _context36.stop();
          }
        }, _callee36, this, [[12, 44, 47, 50], [20, 34, 37, 40]]);
      }));
      function getGlobalScore(_x43, _x44, _x45) {
    ...
    key: "clear",
    value: function () {
      var _clear = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee37() {
...
var printTable = function printTable(title, subtitle, htmlTable) {
  var printWindow = window.open('', '', 'height=800,width=1000');
  printWindow.document.write("\n        <html>\n            <head>\n                <title>Print</title>\n                <link rel=\"stylesheet\" type=\"text/css\" href=\"style.css\">\n                <style>\n                    @page { margin: 0; }\n                    body {\n                        padding-left: 16px;\n                        padding-right: 16px;\n                        font-size: 13px;\n                    }\n                </style>\n            </head>\n            <body>\n                ".concat(title, "\n                ").concat(subtitle, "\n                <table class=\"w-full table-auto\">").concat(htmlTable, "</table>\n            </body>\n        </html>"));
...
/******/ })()
;
//# sourceMappingURL=bundle-0fd82a23d2624b5a8cdd.js.map