            ...
            while (1) switch (_context2.prev = _context2.next) {
              ...
              case 6:
                ...
                if (ok) {
                  ...
                  _this2._ref('count').innerHTML = _this2.rows.length;
                }
              case 8:
              case "end":
      ...
      var _reload = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
        ...
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              (0,_libs_utils__WEBPACK_IMPORTED_MODULE_2__.emptyElement)(this.tableBody);
              parent = this._parent();
              _context4.next = 4;
              return parent.getRows(this.rowsKey);
            case 4:
  ...
  _createClass(M1Dashboard, [{
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.next = 3;
              return this.dbManager.getAllTakeJoin(this.raceId, (_this$ps = this.ps) === null || _this$ps === void 0 ? void 0 : _this$ps.id);
            case 3:
    ...
    value: function _setTime(time) {
      ...
      var formData = _objectSpread(_objectSpread({}, time), {}, {
        psName: (_this$ps2 = this.ps) === null || _this$ps2 === void 0 ? void 0 : _this$ps2.name,
...
var DBManager = /*#__PURE__*/function () {
  ...
  _createClass(DBManager, [{
    ...
    key: "getAllTakeJoin",
    value: function () {
      var _getAllTakeJoin = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee27(race, ps) {
        var _this2 = this;
        var takes, result;
        return _regeneratorRuntime().wrap(function _callee27$(_context27) {
          while (1) switch (_context27.prev = _context27.next) {
            case 0:
              _context27.next = 2;
              return this.getAllTake(race, ps);
            case 2:
      ...
      function getAllTakeJoin(_x26, _x27) {
    ...
    value: function () {
      var _getAllCategories = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee28(race) {
        ...
        return _regeneratorRuntime().wrap(function _callee28$(_context28) {
          while (1) switch (_context28.prev = _context28.next) {
            ...
            case 2:
              runners = _context28.sent;
              categories = runners.map(function (item) {
                return item.category;
              });
              return _context28.abrupt("return", _toConsumableArray(new Set(categories)));
            case 5:
            case "end":
      ...
      function getAllCategories(_x29) {
    ...
    key: "getScore",
    value: function () {
      var _getScore = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee29(psId, race, category) {
        ...
        return _regeneratorRuntime().wrap(function _callee29$(_context29) {
          while (1) switch (_context29.prev = _context29.next) {
            ...
            case 44:
              _context29.prev = 44;
              _context29.t0 = _context29["catch"](22);
              _iterator.e(_context29.t0);
            case 47:
              _context29.prev = 47;
              _iterator.f();
              return _context29.finish(47);
            case 50:
        ...
        }, _callee29, this, [[22, 44, 47, 50]]);
      }));
      function getScore(_x30, _x31, _x32) {
    ...
    key: "clear",
    value: function () {
      var _clear = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee30() {
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "                                <option value=\""
    + alias4(((helper = (helper = lookupProperty(helpers,"id") || (depth0 != null ? lookupProperty(depth0,"id") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data,"loc":{"start":{"line":47,"column":47},"end":{"line":47,"column":53}}}) : helper)))
    + "\" "
    + ((stack1 = lookupProperty(helpers,"if").call(alias1,(depth0 != null ? lookupProperty(depth0,"selected") : depth0),{"name":"if","hash":{},"fn":container.program(2, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":47,"column":55},"end":{"line":47,"column":86}}})) != null ? stack1 : "")
    + ">\n                                    "
    + alias4(((helper = (helper = lookupProperty(helpers,"name") || (depth0 != null ? lookupProperty(depth0,"name") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"name","hash":{},"data":data,"loc":{"start":{"line":48,"column":36},"end":{"line":48,"column":44}}}) : helper)))
    + "\n                                </option>\n";
  ...
  return "<div class=\"lg:flex w-full\">\n    <div class=\"w-full lg:w-2/3 lg:pr-2\">\n\n        <div class=\"mb-8\">\n            <c1-table\n                labels=\"id,Data\"\n                keys=\"id,time\"\n                orderBy=\"time\"\n                rowsKey=\"time\"\n                orderDir=\"desc\"\n                editEnabled=\"true\"\n                title=\"Tempi non assegnati\"\n                ref=\"timeTable\"\n            ></c1-table>\n        </div>\n\n        <div>\n            <c1-table\n                labels=\"ID,Time,PS,Data,Nome,Num\"\n                keys=\"id,assignedIdTime,assignedPs,assignedTime,assignedName,assigned\"\n                filterKey=\"assignedName\"\n                orderBy=\"assigned\"\n                rowsKey=\"take\"\n                title=\"Tempi assegnati\"\n                ref=\"takeTable\"\n            ></c1-table>\n        </div>\n    </div>\n    <div class=\"w-full lg:w-1/3\">\n\n        <div\n            class=\"bg-white rounded-lg shadow sm:max-w-md sm:w-full sm:mx-auto sm:overflow-hidden transition-colors mb-4\"\n        >\n\n            <div class=\"px-4 py-4 sm:px-10\">\n                <div class=\"w-full space-y-6\">\n                    <div class=\"w-full\">\n                        <select\n                            class=\"font-semibold w-full block px-3 py-2 text-gray-700 bg-white border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-primary-500 focus:border-primary-500\"\n                            required\n                            ref=\"selectPs\"\n                        >\n                            <option value=\"\">\n                                Tutte le PS\n                            </option>\n"
    + ((stack1 = lookupProperty(helpers,"each").call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? lookupProperty(depth0,"pss") : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":46,"column":28},"end":{"line":50,"column":37}}})) != null ? stack1 : "")
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class=\"lg:flex w-full\">\n    <div class=\"w-full lg:w-2/3 lg:pr-2\">\n        <c1-table\n            labels=\"ID,Num,Nome,Categoria,Start,End,Diff\"\n            keys=\"id,number,name,category,start,end,diff\"\n            filterKey=\"name\"\n            orderBy=\"diff\"\n            actionDisabled=\"true\"\n            ref=\"table\"\n        ></c1-table>\n    </div>\n    <div class=\"w-full lg:w-1/3\">\n        <div class=\"bg-white rounded-lg shadow sm:max-w-md sm:w-full sm:mx-auto sm:overflow-hidden\">\n\n            <div class=\"px-4 py-8 sm:px-10\">\n                <div class=\"w-full space-y-6\">\n                    <div class=\"w-full\">\n                        <select\n                            class=\"font-semibold w-full block px-3 py-2 text-gray-700 bg-white border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-primary-500 focus:border-primary-500\"\n                            ref=\"selectCategory\"\n                        >\n                            <option value=\"\">\n                                Tutte le Categorie\n                            </option>\n"
